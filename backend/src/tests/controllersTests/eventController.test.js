...
describe('Event Controller', () => {
  ...
  describe('updateEvent', () => {
    it('should update event successfully', async () => {
      ...
      eventService.updateEvent.mockResolvedValueOnce(expectedResult);
    ...
    it('should handle validation errors in update', async () => {
      ...
      eventService.updateEvent.mockRejectedValueOnce(error);
  ...
  describe('deleteEvent', () => {
    it('should delete event successfully', async () => {
      ...
      eventService.deleteEvent.mockResolvedValueOnce(expectedResult);
    ...
    it('should handle not found error in delete', async () => {
      ...
      eventService.deleteEvent.mockRejectedValueOnce({
        status: 404,
        message: 'Event not found'
      });
